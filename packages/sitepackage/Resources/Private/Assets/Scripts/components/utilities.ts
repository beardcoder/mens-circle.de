import type { LazyLoaderFactory, FAQAccordionFactory, PerformanceMonitorFactory, ObserverOptions } from '../types/index'
    ...
    const handleClick = (item: HTMLElement) => (e: Event) => {
        ...
        faqItems.forEach((otherItem) => {
            if (otherItem !== item) {
                ...
                const otherAnswer = otherItem.querySelector<HTMLElement>('.faq__answer')
                if (otherAnswer) {
