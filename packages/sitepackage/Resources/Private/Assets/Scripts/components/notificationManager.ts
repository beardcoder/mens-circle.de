import type { NotificationType, NotificationOptions, NotificationManagerFactory } from '../types/index'
...
export const createNotificationManager = (): NotificationManagerFactory => {
    ...
    const createNotificationElement = (message: string, type: NotificationType): HTMLDivElement => {
