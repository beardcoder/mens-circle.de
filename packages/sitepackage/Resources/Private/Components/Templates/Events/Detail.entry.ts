...
import './Map.css'
import { createComponent, createComponentAndMount } from '../../../Assets/utils/createComponent.ts'

void createComponentAndMount('event-location', '[data-component="event-location"]', ({ element }) => {
