...
final class ContentBlocksTextUpgradeWizard implements UpgradeWizardInterface
{
    private const TABLE = 'tt_content';
    private const OLD_TYPE = 'menscircle_text';
    private const NEW_TYPE = 'sitepackage_text';
